...
// Variable: SKILLS_CATEGORIES_QUERY
// Query: *[_type == "skillCategory"] | order(order asc){  name,  skills[]->{    name,    category,    proficiency,    percentage,    yearsOfExperience,    color  }}
export type SKILLS_CATEGORIES_QUERY_RESULT = Array<{
  name:
    | "ai-ml"
    | "backend"
    | "cloud"
